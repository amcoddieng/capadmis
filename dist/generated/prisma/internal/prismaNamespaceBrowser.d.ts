...
export declare const EtudiantScalarFieldEnum: {
    readonly id: "id";
    readonly nom: "nom";
    ...
    readonly payes: "payes";
    readonly date_de_naissance: "date_de_naissance";
    readonly lieu_de_naissance: "lieu_de_naissance";
