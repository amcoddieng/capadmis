...
import { createPersonnel, loginPersonnel, updatePersonnelById, updateSelfPersonnel, deletePersonnelById, bloquerPersonnel, listerPersonnelPourSuperAdmin, listerConseillersPourAdmin, } from '../controllers/personnelController.js';
import { verifyPersonnelToken, requireSuperAdmin, requireSuperAdminOrAdmin, } from '../middleware/personnelMiddleware.js';
const router = Router();
